                      ...
                      <TableRow key={counselor.id}>
                        ...
                        <td className="w-[130px]">
                          <ButtonPrimary
                            ...
                            onClick={() => getCounselor(counselor.id)}
                          >
                            <Visibility
                              className="mr-1"
                        ...
                        <td className="w-[130px]">
                          <ButtonOutline
                            className="w-[90%] font-medium"
                            onClick={() =>
                              openModalConfirmCounselor(counselor.id)
                            }
                          >
                            <Delete
                              className="mr-1"
                    ...
                    usersData.map((user) => (
                      <TableRow key={user.id}>
                        ...
                        <td className="w-[130px]">
                          <ButtonOutline
                            className="w-[90%] font-medium"
                            onClick={() => openModalConfirmUser(user.id)}
                          >
                            <Delete
                              className="mr-1"
                              style={{ fontSize: "1.125rem" }}
        ...
        <div>
          <form className="mb-3" onSubmit={handleSubmit(onSubmit)}>
            ...
            <InputField
              ...
              label="Description"
              type="text"
              placeholder="Ex : Counselor work to empower women to make positive changes"
              errors={errors}
              register={register}
            />
            <InputField
              name="price"
              label="Counseling Price"
              type="number"
              placeholder="Ex : Rp 200,000"
              errors={errors}
              register={register}
            />
            <ButtonPrimary className="h-fit w-full px-3 py-3 flex items-center justify-center font-medium">
              + Add New Counselor
            </ButtonPrimary>
          </form>
          <ButtonOutline
            className="h-fit w-full px-3 py-3 flex items-center justify-center font-medium"
            onClick={handleAdd}
          >
            Not Now
          </ButtonOutline>
